...
class CustomExpansionTile extends StatefulWidget {
  ...
  // static bool isExpanded = false;
   // static handleTap(BuildContext context){
   //   _CustomExpansionTileState().handle(context);
   // }
...
// }
  ...
  Widget? _buildIcon(BuildContext context) {
    return RotationTransition(
      turns: _iconTurns,
      child:  Icon(Icons.arrow_forward, size: MediaQuery.of(context).size.height * 0.03),
    );
  }
